...
import com.sparkle.roam.BuildConfig;
...
public class ConstantMethod {
    ...
    public static boolean Checkemail(String s) {
        Pattern sPattern = Pattern.compile(Constants.EMAIL_PATTERN);
    ...
    public static String ASCIItoHEX(String ascii) {
        ...
        for (int i = 0; i < ascii.length(); i++) {
            ...
            int in = (int) ch;
            String part = Integer.toHexString(in).toUpperCase();
            hex += part;
        }
        return hex;
    }
    ...
    public static boolean Checkpass_username(String s) {
        Pattern sPattern = Pattern.compile(Constants.PASSWORD_PATTERN);
...
//    }
    ...
    public static String ConvertProperUl(String url) {
        if (url != null && url.length() > 5) {
            ...
            if (substr.equals("http"))
                ...
                return Constants.IMAGE_PATH + url;
        } else
            return "";
    }
    ...
    public static void ShowInstract(Context context) {
        SharedPreferences sharedpreferences = context
                .getSharedPreferences(Constants.INTRO_PREF, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedpreferences.edit();
        editor.putBoolean(Constants.IS_SHOW_INTRO, true);
        editor.commit();
    }
    ...
    public static boolean IsCheckInstract(Context context) {
        SharedPreferences sharedpreferences = context
                .getSharedPreferences(Constants.INTRO_PREF, Context.MODE_PRIVATE);
        return sharedpreferences.getBoolean(Constants.IS_SHOW_INTRO, false);
    }
...
////                    Constants.Dialogcode.WARNING).show();
//        }
//
//    }
//
